...
function showCommentPrompt(overlay, tip, selectedRect, cleanup, saveSelection) {
  document.querySelector("#frami-comment-prompt")?.remove();
  tip.textContent = "Add a comment, then save this area.";
  ...
  title.textContent = "Save selected area";
  ...
  save.addEventListener("click", async () => {
    await saveSelection(selectedRect, textarea.value);
  });
